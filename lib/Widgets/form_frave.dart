  ...
  Widget build(BuildContext context)
  {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        fillColor: fillColor,
        hintText: hintText,
        hintStyle: GoogleFonts.getFont('Roboto', color:const Color(0xffB4B9C0)),
        prefixIcon: isIcon ? Icon(prefixIcon, color:const Color(0xffB4B9C0)) : null,
        suffixIcon: isSuffixIcon 
          ? IconButton( 
              icon: Icon(suffixIcon),
              color:const  Color(0xffB4B9C0),
