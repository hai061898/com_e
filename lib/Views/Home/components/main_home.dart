...
class _ListHomeState extends State<ListHome> {
  ...
  ScrollController scrollControllerHome = ScrollController(); // controller thanh cuộn 
  ...
  void initState() {
    ...
    scrollControllerHome.addListener(() { 
      ...
      if( scrollControllerHome.offset > scrollPrevious ){ // Độ lệch cuộn hiện tại của tiện ích con có thể cuộn > scrollPrevious (chỉ cần có hiệu ứng scoll là menu bottom sẽ hiện ra)
                                ...
                                child: Center(
                                  child: BlocBuilder<ProductBloc, ProductState>(
                                    builder: (context, state) 
                                      => state.amount == 0 
                                        ?const TextFrave(text: '0', color: Colors.white, fontWeight: FontWeight.bold )
